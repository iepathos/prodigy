...
async fn test_basic_workflow_composition() -> Result<()> {
    ...
    let workflow = ComposableWorkflow::from_config(WorkflowConfig { commands: vec![], env: None, secrets: None, env_files: None, profiles: None });
...
async fn test_workflow_with_parameters() -> Result<()> {
    let mut workflow = ComposableWorkflow::from_config(WorkflowConfig { commands: vec![], env: None, secrets: None, env_files: None, profiles: None });
...
async fn test_template_registry() -> Result<()> {
    ...
    let template = ComposableWorkflow::from_config(WorkflowConfig { commands: vec![], env: None, secrets: None, env_files: None, profiles: None });
...
async fn test_template_search_by_tags() -> Result<()> {
    ...
    let template1 = ComposableWorkflow::from_config(WorkflowConfig { commands: vec![], env: None, secrets: None, env_files: None, profiles: None });
    ...
    let template2 = ComposableWorkflow::from_config(WorkflowConfig { commands: vec![], env: None, secrets: None, env_files: None, profiles: None });
