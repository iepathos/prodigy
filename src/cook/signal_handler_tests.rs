...
mod tests {
    ...
    fn test_signal_terminates_process() {
        ...
        assert!(!exit_status.success(), "Process should not exit successfully after SIGINT");
    }
...
mod integration_tests {
    ...
    fn test_signal_handler_thread_spawns() {
        ...
        assert!(handler_started.load(Ordering::SeqCst), "Handler thread should start");
    }
}
...
mod subprocess_tests {
    ...
    async fn test_subprocess_with_process_group() {
        ...
        let command = ProcessCommand {
            ...
            args: vec!["-c".to_string(), "echo 'parent'; sleep 0.1; echo 'done'".to_string()],
            env: HashMap::new(),
            working_dir: None,
