...
mod tests {
    ...
    async fn test_handler_output_formatter() {
        ...
        let output = ProcessOutput::new().with_stdout("handler output".to_string());
    ...
    async fn test_output_processor_process_output() {
        ...
        let raw_output = ProcessOutput::new().with_stdout("test output".to_string());
        ...
        let raw_output =
            ProcessOutput::new().with_stdout("Claude: Info\nActual output".to_string());
