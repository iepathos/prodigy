...
fn main() {
    ...
    // Man page generation disabled (clap_mangen dependency removed)
    // #[cfg(not(doc))]
    // generate_man_pages();
}
...
// CLI building functions disabled (clap_mangen dependency removed)

// All build subcommand functions disabled (clap_mangen dependency removed)
